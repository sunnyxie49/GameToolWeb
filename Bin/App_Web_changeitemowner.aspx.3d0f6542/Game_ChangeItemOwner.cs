...
public class Game_ChangeItemOwner : Page, IRequiresSessionState
{
	...
	protected void btnChangeAccount_Click(object sender, EventArgs e)
	{
			...
			if (result > 0)
			{
				...
				switch (num)
				{
					...
					case -1:
						...
						break;
					case -2:
						common.MsgBox(this, "Owner", "The character’s name is incorrect.");
						break;
					case -3:
						common.MsgBox(this, "Owner", "The item is incorrect.");
						break;
					case -4:
						common.MsgBox(this, "Owner", "One of the accounts is connected in the game.");
						break;
					case -5:
						common.MsgBox(this, "Owner", "The account is incorrect.");
						break;
					default:
						common.MsgBox(this, "Owner", "fail");
						break;
				}
			}
			else
		...
		{
			common.MsgBox("没有权限", base.Request.Url.ToString());
		}
	}
