...
public class Game_character_info : Page, IRequiresSessionState
{
	...
	protected void btnGiveGM_Click(object sender, EventArgs e)
	{
		...
		{
			common.MsgBox(this, "CInfo", "[Give GM Permission] No Permission.");
		}
	}
	...
	protected void btnDelGM_Click(object sender, EventArgs e)
	{
		...
		{
			common.MsgBox(this, "CInfo", "[Remove GM Permission] No Permission.");
		}
	}
	...
	protected void btnWarp_Click(object sender, EventArgs e)
	{
		...
		{
			common.MsgBox(this, "CInfo", "[Warp] No Permission.");
		}
	}
	...
	protected void btnKick_Click(object sender, EventArgs e)
	{
		...
		{
			common.MsgBox(this, "CInfo", "[Kick] No Permission.");
		}
	}
	...
	protected void btnGiveGold_Click(object sender, EventArgs e)
	{
		if (admin.Authority(ddlServer.SelectedValue, "gmtool_insert_gold"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "gold is 0");
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[Give Gold] No Permission.");
		}
	}
	...
	protected void btnTaiming_Click(object sender, EventArgs e)
	{
		...
		{
			common.MsgBox(this, "CInfo", "[Taiming] No Permission.");
		}
	}
	...
	protected void btnWarp2_Click(object sender, EventArgs e)
	{
		if (admin.Authority(ddlServer.SelectedValue, "gmtool_warp"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "Warp Success \n\n " + result_msg);
			}
			else
			{
				common.MsgBox(this, "CInfo", "Warp Fail \n\n " + result_msg);
			}
		}
		else
		{
	...
	protected void btnChangeName_Click(object sender, EventArgs e)
	{
		if (admin.Authority(ddlServer.SelectedValue, "gmtool_change_avatar_name"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "Name Modify : Success \n\n " + result_msg);
			}
			else
			{
				common.MsgBox(this, "CInfo", "Name Modify : Failure \n\n " + result_msg);
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[Name Modify] No Permission.");
		}
	}
	...
	protected void btnChangeExp_Click(object sender, EventArgs e)
	{
		if (admin.Authority(ddlServer.SelectedValue, "gmtool_change_character_exp"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "Exp Modify : Success \n\n " + result_msg);
			}
			else
			{
				common.MsgBox(this, "CInfo", "Exp Modify : Failure \n\n " + result_msg);
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[EXP Modify] No Permission.");
		}
	}
	...
	protected void btnChangeJP_Click(object sender, EventArgs e)
	{
		if (admin.Authority(ddlServer.SelectedValue, "gmtool_change_character_exp"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "JP Modify : Success \n\n " + result_msg);
			}
			else
			{
				common.MsgBox(this, "CInfo", "JP Modify : Failure \n\n " + result_msg);
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[JP Modify] No Permission.");
		}
	}
	...
	protected void btnChangeGold_Click(object sender, EventArgs e)
	{
		if (admin.Authority(ddlServer.SelectedValue, "gmtool_change_character_gold"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "Gold Modify : Success \n\n " + result_msg);
			}
			else
			{
				common.MsgBox(this, "CInfo", "Gold Modify : Failure\n\n " + result_msg);
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[Gold Modify] No Permission.");
		}
	}
	...
	protected void btnChangeLac_Click(object sender, EventArgs e)
	{
		if (admin.Authority(ddlServer.SelectedValue, "gmtool_change_character_lac"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "Lak Modify : Success \n\n " + result_msg);
			}
			else
			{
				common.MsgBox(this, "CInfo", "Lak Modify : Failure\n\n " + result_msg);
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[Lak Modify] No Permission.");
		}
	}
	...
	protected void btnChangeStamina_Click(object sender, EventArgs e)
	{
		if (admin.Authority(ddlServer.SelectedValue, "gmtool_change_character_stamina"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "Stamina Modify : Success\n\n " + result_msg);
			}
			else
			{
				common.MsgBox(this, "CInfo", "Stamina Modify : Failure\n\n " + result_msg);
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[Stamina Modify] No Permission.");
		}
	}
	...
	protected void btnDeletedCharactedRestore_Click(object sender, EventArgs e)
	{
		if (admin.Authority(ddlServer.SelectedValue, "gmtool_restore_deleted_character"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "Restore Done");
			}
			else
			{
				common.MsgBox(this, "CInfo", "Restore Fail, Please Check Character Name. if already same name exist, can't restore");
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[restore_deleted_character Modify] No Permission.");
		}
	}
	...
	protected void btnChangeChatBlockTime_Click(object sender, EventArgs e)
	{
		if (admin.Authority(ddlServer.SelectedValue, "gmtool_change_character_chat_block_time"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "chat_block_time Modify : Success\n\n " + result_msg);
			}
			else
			{
				common.MsgBox(this, "CInfo", "chat_block_time Modify : Failure\n\n " + result_msg);
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[chat_block_time Modify] No Permission.");
		}
	}
	...
	protected void btnChangeHuntaHolicPoint_Click(object sender, EventArgs e)
	{
		if (admin.Authority(ddlServer.SelectedValue, "gmtool_change_character_huntaholic_point"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "HuntaHolic Point Modify : Success\n\n " + result_msg);
			}
			else
			{
				common.MsgBox(this, "CInfo", "HuntaHolic Point Modify : Failure\n\n " + result_msg);
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[HuntaHolic Point Modify] No Permission.");
		}
	}
	...
	protected void btnImmoralPoint_Click(object sender, EventArgs e)
	{
		if (admin.Authority(ddlServer.SelectedValue, "gmtool_change_character_ip"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "Immoral Point Modify : Success \n\n " + result_msg);
			}
			else
			{
				common.MsgBox(this, "CInfo", "Immoral Point Modify : Failure \n\n " + result_msg);
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[Immoral Point Modify] No Permission.");
		}
	}
	...
	protected void btnCha_Click(object sender, EventArgs e)
	{
		if (admin.Authority(ddlServer.SelectedValue, "gmtool_change_character_cha"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "CHA Modify : Success\n\n " + result_msg);
			}
			else
			{
				common.MsgBox(this, "CInfo", "CHA Modify : Failure\n\n " + result_msg);
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[CHA Modify] No Permission.");
		}
	}
	...
	protected void btnPkc_Click(object sender, EventArgs e)
	{
		if (admin.Authority(ddlServer.SelectedValue, "gmtool_change_character_pkc"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "PKC Modify : Success\n\n " + result_msg);
			}
			else
			{
				common.MsgBox(this, "CInfo", "PKC Modify : Failure\n\n " + result_msg);
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[PKC Modify] No Permission.");
		}
	}
	...
	protected void btnDkc_Click(object sender, EventArgs e)
	{
		if (admin.Authority(ddlServer.SelectedValue, "gmtool_change_character_dkc"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "DKC Modify : Success\n\n " + result_msg);
			}
			else
			{
				common.MsgBox(this, "CInfo", "DKC Modify : Failure\n\n " + result_msg);
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[DKC Modify] No Permission.");
		}
	}
	...
	protected void btnAutoSetGame_Click(object sender, EventArgs e)
	{
		...
		{
			common.MsgBox(this, "CInfo", "[Set Auto User] No Permission.");
		}
	}
	...
	protected void btnAutoDelGame_Click(object sender, EventArgs e)
	{
		...
		{
			common.MsgBox(this, "CInfo", "[Set No Auto User] No Permission.");
		}
	}
	...
	protected void btnSetSecurityNumber_Click(object sender, EventArgs e)
	{
		...
		{
			common.MsgBox(this, "CInfo", "[Set Security Number] No Permission.");
		}
	}
	...
	protected void btnEtherealStoneDurability_Click(object sender, EventArgs e)
	{
		...
		else if (admin.Authority(ddlServer.SelectedValue, "gmtool_change_character_durability"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "EtherealStoneDurability Modify : Success\n\n " + result_msg);
			}
			else
			{
				common.MsgBox(this, "CInfo", "EtherealStoneDurability Modify : Failure\n\n " + result_msg);
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[Set Ethereal Stone Durability] No Permission.");
		}
	}
	...
	protected void btnAP_Click(object sender, EventArgs e)
	{
		...
		else if (admin.Authority(ddlServer.SelectedValue, "gmtool_change_character_ap"))
		{
			...
			{
				common.MsgBox(this, "CInfo", "AP Modify : Success\n\n " + result_msg);
			}
			else
			{
				common.MsgBox(this, "CInfo", "AP Modify : Failure\n\n " + result_msg);
			}
		}
		else
		{
			common.MsgBox(this, "CInfo", "[Set AP] No Permission.");
		}
	}
}
