...
public class Game_character_info_arena : Page, IRequiresSessionState
{
	...
	private void GetCharacterInfo()
	{
		...
		sqlConnection.Open();
		sqlCommand.CommandText = "gmtool_v2_get_character_info_Arena";
		...
		Game_Skin_skin_arena_list game_Skin_skin_arena_list = (Game_Skin_skin_arena_list)LoadControl("skin/skin_arena_list.ascx");
		game_Skin_skin_arena_list.dtArenaList = dataSet.Tables[1];
		game_Skin_skin_arena_list.SelectedServer = selected_server;
		game_Skin_skin_arena_list.ResourceDbNo = resource_db_no;
		PlaceHolder2.Controls.Add(game_Skin_skin_arena_list);
	}
}
