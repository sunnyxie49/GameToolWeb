...
public class Game_character_info_skill : Page, IRequiresSessionState
{
	...
	private void GetCharacterInfo()
	{
		...
		sqlConnection.Open();
		sqlCommand.CommandText = "gmtool_v2_get_character_info_skill";
