...
public class Game_edit_skill : Page, IRequiresSessionState
{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		{
			common.MsgBox(this, "CEditSkill", "您需要服务器值");
		}
		else if (base.Request.QueryString["sid"] == null || base.Request.QueryString["sid"] == "")
		{
			common.MsgBox(this, "CEditSkill", "您需要技能sid值");
		}
		else
		{
	...
	private void GetSkillInfo()
	{
		...
		if (sqlDataReader.Read())
		{
			...
			if (num == 0 && num2 == 0)
			{
				common.MsgBox(this, "CEditSkill", $"没有技能，sid值是 {sid}");
			}
			else
			{
		...
		{
			common.MsgBox(this, "CEditSkill", string.Format("sid值为A的技能没有", sid));
		}
		con.Close();
	}
	...
	protected void btnChange_Click(object sender, EventArgs e)
	{
		try
		{
			...
			{
				common.MsgBox(this, "CEditSkill", "更改技能信息 : 成功\n\n" + result_msg);
			}
			else
			{
				common.MsgBox(this, "CEditSkill", "更改技能信息 : 失败 \n\n" + result_msg);
			}
		}
		catch (Exception ex)
		{
	...
	protected void btnDel_Click(object sender, EventArgs e)
	{
		try
		{
			...
			{
				common.MsgBox(this, "CEditSkill", "删除技能 : 成功 \n\n" + result_msg);
			}
			else
			{
				common.MsgBox(this, "CEditSkill", "删除技能 : 失败 \n\n" + result_msg);
			}
		}
		catch (Exception ex)
		{
