...
public class Game_Skin_skin_shop_list : UserControl
{
	...
	private void rptCommon_ItemDataBound(object sender, RepeaterItemEventArgs e)
	{
		...
		Literal literal = (Literal)e.Item.FindControl("ltrBlank");
		Literal literal2 = (Literal)e.Item.FindControl("ltrsid");
		Literal literal3 = (Literal)e.Item.FindControl("ltrIcon");
		Literal literal4 = (Literal)e.Item.FindControl("ltrSkillName");
		Literal literal5 = (Literal)e.Item.FindControl("ltrType");
		Literal literal6 = (Literal)e.Item.FindControl("ltrInfo");
		Literal literal7 = (Literal)e.Item.FindControl("ltrBlank");
		Literal literal8 = (Literal)e.Item.FindControl("ltrBlank");
