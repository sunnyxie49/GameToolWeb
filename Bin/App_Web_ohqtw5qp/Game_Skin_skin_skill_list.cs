...
public class Game_Skin_skin_skill_list : UserControl
{
	...
	private void rptSkillList_ItemDataBound(object sender, RepeaterItemEventArgs e)
	{
		...
		literal6.Text = string.Format("<input class='btn btn-inverse btn-small' type='button' value='Modify' onClick=\"OpenEditSkillPopup('{0}', '{1}')\">", SelectedServer, ((DataRowView)e.Item.DataItem)["sid"]);
