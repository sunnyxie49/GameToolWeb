<%@ Reference Control="~/Game/skin/skin_arena_list.ascx" %>
<%@ Reference Control="~/Game/skin/skin_character_list.ascx" %>
<%@ page language="C#" autoeventwireup="true" inherits="Game_character_info_arena, App_Web_character_info_arena.aspx.3d0f6542" %><!DOCTYPE html>
